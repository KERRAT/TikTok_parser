...
class SocialNetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_network" do
    assert_difference("SocialNetwork.count") do
      post social_networks_url, params: { social_network: { base_link: @social_network.base_link, name: @social_network.name } }
    end
  ...
  test "should update social_network" do
    patch social_network_url(@social_network), params: { social_network: { base_link: @social_network.base_link, name: @social_network.name } }
